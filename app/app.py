...
async def on_chat_start():
    ...
    template="""
    You are a highly intelligent and friendly shopping assistant named CartPal.
    Based on the user's request, recommend products or shopping advice.
...
async def main(message: cl.Message):
    ...
    response = await chain.arun(
        # question=message.content, callbacks=[cl.LangchainCallbackHandler()]
         user_input=message.content, callbacks=[cl.LangchainCallbackHandler()]
    )
